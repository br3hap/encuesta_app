{
    ...
    'assets': {
        'web.assets_backend': [
            'survey_attachment/static/src/css/survey_result.css',
        ],
        'survey.survey_assets': [
            'survey_attachment/static/src/css/survey_front_result.css',
            'survey_attachment/static/src/js/survey_form.js',
        ],
    },
    'data': [
